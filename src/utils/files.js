...
/**
 * CREATE VINTI4 PAYMENT FORM
 * @param {String} baseDir - Path to store file "fileName"
 * @param {String} fileName - File to store in a directory baseDir
 * @param {HTMLDocument} content - Content to store inside the fileName
 * @returns {Boolean} response - True for success
 */
const createVinti4PaymentFile = async (baseDir, fileName, content) => {
  try {
...
module.exports = {
  deleteVinti4PaymentFile,
  createVinti4PaymentFile
};
