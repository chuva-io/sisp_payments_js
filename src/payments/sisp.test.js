...
describe('SISP Payment', () => {
  describe('processing webhook', () => {
    describe('successful payment', () => {
      ...
      it('should return the correct response', async () => {
        const result = await sisp.processWebhook(successData);
  ...
  describe('handle SISP payment', () => {
    ...
    it('should return the correct response merchantRespMerchantRef', async () => {
      const result = await sisp.orderDataFromWebhook(requestBody1);
    ...
    it('should return the correct response merchant_ref', async () => {
      const result = await sisp.orderDataFromWebhook(requestBody2);
    ...
    it('should return the correct response merchantRef', async () => {
      const result = await sisp.orderDataFromWebhook(requestBody3);
